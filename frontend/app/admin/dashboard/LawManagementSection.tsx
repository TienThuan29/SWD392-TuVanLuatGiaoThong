...
export default function LawManagementSection() {
  ...
  const { lawTypes, loading: lawTypeLoading, getAllLawTypes, createLawType, updateLawType, deleteLawType } = useLawTypeCrud();
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">
          {showLawTypes ? 'Quản lý loại luật' : 'Quản lý dữ liệu luật'}
        </h2>
        <div className="flex gap-3">
          ...
          >
            {showLawTypes ? 'Xem danh sách luật' : 'Xem loại luật'}
          </button>
          {!showLawTypes && (
            <>
              <button
              ...
              >
                ...
                <FaPlus /> {isCreatingLawType ? 'Đang tạo...' : 'Tạo loại luật mẫu'}
              </button>
              <button
