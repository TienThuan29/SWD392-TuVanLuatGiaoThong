            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="text-center">
                        <Spinner_C />
                        <p className="mt-4 text-gray-600 dark:text-gray-400">Đang tải dữ liệu luật...</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center">
                            <div className={`p-2 bg-[${Color.MainColor}]/10 dark:bg-[${Color.MainColor}]/20 rounded-lg`}>
                                <FileText className={`w-6 h-6 text-[${Color.MainColor}]`} />
                            </div>
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Tổng số văn bản</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{laws.length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Đã tìm thấy</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{filteredLaws.length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Loại văn bản</p>
                        ...
                        {filteredLaws.map((law) => (
                            ...
                            >
                                <div className="p-6 flex flex-col flex-1">
                                    ...
                                    {/* Title */}
                                    <h3 className={`text-lg font-semibold text-gray-900 dark:text-white mb-3 line-clamp-3 group-hover:text-[${Color.MainColor}] transition-colors`}>
                                        {law.title}
                                    </h3>
