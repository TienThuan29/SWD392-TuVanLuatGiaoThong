...
import { FaUser, FaCalendarAlt, FaQuestionCircle, FaHome } from 'react-icons/fa'
      ...
      <div className="flex h-[calc(100vh-64px)]">
        ...
        <div className="w-64 border-r border-gray-200/50 bg-white/95 backdrop-blur-sm h-full">
          <div className="flex flex-col h-full">
            ...
            <h3 className="text-center text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Tùy chọn</h3>
            
            {/* Profile Section */}
            <div className="px-4 py-2">
              <button 
                onClick={() => setActiveTab('profile')}
                className={`w-full group flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 transition-all duration-300 rounded-lg hover:shadow-md active:scale-95 border border-gray-200/50 hover:border-gray-300/50 ${
                  activeTab === 'profile' ? 'bg-gray-50 shadow-md border-gray-300/50' : ''
                }`}
              >
                <div className="flex items-center justify-center w-9 h-9 rounded-full bg-white/80 group-hover:bg-white transition-colors duration-300 shadow-sm group-hover:shadow-md border border-gray-200/50 group-hover:border-gray-300/50">
            ...
            <div className="px-4 py-2">
              <button 
                ...
                className={`w-full group flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 transition-all duration-300 rounded-lg hover:shadow-md active:scale-95 border border-gray-200/50 hover:border-gray-300/50 ${
                  activeTab === 'planning' ? 'bg-gray-50 shadow-md border-gray-300/50' : ''
                }`}
              >
                <div className="flex items-center justify-center w-9 h-9 rounded-full bg-white/80 group-hover:bg-white transition-colors duration-300 shadow-sm group-hover:shadow-md border border-gray-200/50 group-hover:border-gray-300/50">
            ...
            <div className="px-4 py-2">
              <button 
                ...
                className={`w-full group flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 transition-all duration-300 rounded-lg hover:shadow-md active:scale-95 border border-gray-200/50 hover:border-gray-300/50 ${
                  activeTab === 'help' ? 'bg-gray-50 shadow-md border-gray-300/50' : ''
                }`}
              >
                <div className="flex items-center justify-center w-9 h-9 rounded-full bg-white/80 group-hover:bg-white transition-colors duration-300 shadow-sm group-hover:shadow-md border border-gray-200/50 group-hover:border-gray-300/50">
